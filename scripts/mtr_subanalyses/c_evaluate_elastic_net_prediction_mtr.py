"""Analyse the results of the prediction with elastic net regression with MTR images.
...
from brain_stats_tools.config import NOT_AVAILABLE, PREDICTION_OUTPUT_DIR_MTR
...
results_markersets = [
    "MTR_variable_median_level_Whole_Brain",
    "MTR_variable_median_level_Structure",
    "MTR_variable_median_level_Region",
    "MTR_variable_p10_level_Whole_Brain",
    "MTR_variable_p10_level_Structure",
    "MTR_variable_p10_level_Region",
]


# %%
# list all CSV files with brain markers
results_csv_files = list(PREDICTION_OUTPUT_DIR_MTR.glob("*.csv"))
